---
title: "ITS workflow-Alpha Diversity"
author: "Sarah Daly"
date: '2024-07-30'
output:
...
```{r}
setwd("C:/Users/dalys/Box/Microbial Food Safety & Spoilage Lab/Lab Members/Sarah Daly/ITS Methods Project/Github upload/Alpha Diversity")
...
alpha.divs <- plot_richness(ps, x="RoomType", measures="Shannon") +
    geom_boxplot() +
    theme_classic() +
    theme(text = element_text(size=24,colour="black",face="bold"),strip.background = element_blank(), axis.text.x.bottom = element_text(angle = -90))

write.csv(alpha.divs$data, "Shannon Diversity.csv")
